...
import Burger from "@/components/Data/Burger";
  ...
  function justTrack() {
    return (
      ...
      <div onMouseEnter={() => {setBurger(index); console.log(burger)}} onMouseLeave={() => setBurger(-1)} className={stylesBurger.burger__cross} >
        <Burger uslovie={burger == index} track={track} playlist={playlist} index={index} setChangeId={setChangeId} setBurger={setBurger} />
